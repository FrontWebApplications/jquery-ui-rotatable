...
a.addClass("ui-rotatable-handle"),0!==this.options.handleOffset.top||0!==this.options.handleOffset.left)a.css("position","relative"),a.css("top",this.options.handleOffset.top+"px"),a.css("left",this.options.handleOffset.left+"px");this.listeners={rotateElement:c.proxy(this.rotateElement,this),startRotate:c.proxy(this.startRotate,this),stopRotate:c.proxy(this.stopRotate,this),wheelRotate:c.proxy(this.wheelRotate,this)};
